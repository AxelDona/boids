...
void Scene::updateCurrentSkin() {
    if (m_currentSkin.m_id != m_currentSkinID) {
        ...
        m_skinParameters.m_isIdDisplayed                 = m_currentSkin.m_defaultDisplayOptions.m_isIdDisplayedByDefault;
        m_skinParameters.m_isNameDisplayed               = m_currentSkin.m_defaultDisplayOptions.m_isNameDisplayedByDefault;
        m_skinParameters.m_isProximityAlertDisplayed     = m_currentSkin.m_defaultDisplayOptions.m_isProximityAlertDisplayedByDefault;
        m_skinParameters.m_isDetectionDisplayed          = m_currentSkin.m_defaultDisplayOptions.m_isDetectionDisplayedByDefault;
        m_skinParameters.m_isAvoidanceRadiusDisplayed    = m_currentSkin.m_defaultDisplayOptions.m_isAvoidanceRadiusDisplayedByDefault;
        m_skinParameters.m_isDistanceToNeighborDisplayed = m_currentSkin.m_defaultDisplayOptions.m_isDistanceToNeighborDisplayedByDefault;
        m_skinParameters.m_isEdgeReflectionDisplayed     = m_currentSkin.m_defaultDisplayOptions.m_isEdgeReflectionDisplayedByDefault;
        m_skinParameters.m_isBoidsNumberDisplayed        = m_currentSkin.m_defaultDisplayOptions.m_isBoidsNumberDisplayedByDefault;
        m_skinParameters.m_pointerInteraction            = m_currentSkin.m_defaultDisplayOptions.m_isPointerInteractionEnabledByDefault;
